<?php function front_home_news_dev($count = 10) { 
	...
	echo '<h2 class="purple">Electric Bike Updates</h2>';
    ...
    echo '<h4 style="text-align: center;"><a href="/electric-bike-news-features/">More News & Features...</a></h4>';
